...
ThemeData light = ThemeData(
  ...
  primaryColor: const Color(0xFF6A0AD6),
  secondaryHeaderColor: const Color(0xFFB88AE8),
  ...
  textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: const Color(0xFF6A0AD6))),
  colorScheme: const ColorScheme.light(
          primary: Color(0xFF6A0AD6),
          tertiary: Color(0xff102F9C),
          tertiaryContainer: Color(0xff8195DB),
          secondary: Color(0xFFB88AE8))
