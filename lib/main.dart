    ...
    if (GetPlatform.isWeb) {
      await Firebase.initializeApp(
        options: const FirebaseOptions(
          apiKey: 'AIzaSyBdKOnJAR4qUccX62CTht5fEhwdwEI8Cos',
          appId: '1:979347599110:android:7ee78e3dccfd42b4b1f887',
          messagingSenderId: '979347599110',
          projectId: 'speedly-customer',
        ),
      );
      MetaSEO().config();
